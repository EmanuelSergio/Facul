...
public class RelatorioVeiculo extends javax.swing.JFrame {
    ...
    public void criarRelatorio(Veiculo veiculo){
        relatorio.append("Informações do veículo \n");
        relatorio.append("Placa: "+veiculo.getPlaca()+ "\n");
        relatorio.append("KM: "+veiculo.getKm()+ "\n");
        relatorio.append("Categoria: "+veiculo.getCategoria()+ "\n");
        relatorio.append("Valor da diária: $: "+veiculo.getPrecoDiaria()+ "\n");
