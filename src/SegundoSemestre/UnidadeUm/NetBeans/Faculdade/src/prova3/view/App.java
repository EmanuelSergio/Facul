...
public class App extends javax.swing.JFrame {
    ...
    private static final String arquivo = "C:\\teste\\alunos.csv";
    ...
    public App() {
        ...
        controller.lerArquivo(arquivo).forEach(linha -> taAlunos.append(String.join(", ", linha)+"\n"));
    ...
    private void btSalvarAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarAlunoActionPerformed
        ...
        controller.salvarAlunos(arquivo ,alunos);
